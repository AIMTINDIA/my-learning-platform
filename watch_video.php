...
<section class="watch-video">
   ...
   <?php
      ...
      if($select_content->rowCount() > 0){
         while($fetch_content = $select_content->fetch(PDO::FETCH_ASSOC)){
            ...
            $pdf_path = $fetch_content['pdf_path'];
   ...
   <div class="video-details">
      <iframe class="video" src="<?= $fetch_content['video']; ?>?modestbranding=1&rel=0" title="BIRD Media Player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
   ...
   <?php if ( !empty($pdf_path)): ?>	 
	             <h4 class="title">Related PDF Document:</h4>
		<!-- Display PDF Name initially -->
		<div id="pdf-name">
			<iframe src="<?php echo $pdf_path; ?>" width="100%" height="350px" frameborder="0" allowfullscreen></iframe>
		</div>

		<?php else: ?>
			<p class="title"><em>No PDF available for this video.</em></p>
		<?php endif; ?>
   </div>		
