...
$conn->query("update placement set cheque='Returned' WHERE registration_id='".$_GET['registration_id']."'");	
...
if(isset($_GET['action']) && $_GET['action']=="approve"){
    ...
    $conn->query("UPDATE placement set cheque = 'Received'  WHERE registration_id='".$_GET['registration_id']."'");	
    header("location: placed.php");
